...
parser.add_argument('--model', default='./logs4/model_best0.1_19.pth.tar', type=str, metavar='PATH',
                    help='path to the model (default: none)')
parser.add_argument('--save', default='./pres4', type=str, metavar='PATH',
...
c = torch.load('./pres4/pruned0.1_19.pth.tar')
cfg = c['cfg']
model = resnet56_cifar(cfg=cfg)
#model = vgg(dataset=args.dataset)
print(model)
if args.cuda:
    model.cuda()
if args.model:
...
savepath = os.path.join(args.save, "prune0.1_20.txt")
...
torch.save({'cfg': cfg1, 'state_dict': newmodel.state_dict()}, os.path.join(args.save, 'pruned0.1_20.pth.tar'))
